                ...
                <div class="single-footer-widget marbtm50">
                    <div class="contact-info-box">
                        <div class="footer-logo">
                            <a href="index-2.html">
                                <img src="{{ asset('front-end/images/footer/footer-logo.png') }}" alt="Awesome Logo">
                            </a>
                        </div>
                        <ul>
                            <li>
                    ...
                    <ul class="recent-news">
                        <li>
                            <div class="img-holder">
                                <img src="{{ asset('front-end/images/footer/recent-news-1.jpg') }}" alt="Awesome Image">
                        ...
                        <li>
                            <div class="img-holder">
                                <img src="{{ asset('front-end/images/footer/recent-news-2.jpg') }}" alt="Awesome Image">
                                <div class="overlay-style-one">
                                    <div class="box">
                                        <div class="content">
                                            <a href="project-single.html"><span class="icon-next"></span></a>
                        ...
                        <li>
                            <div class="img-holder">
                                <img src="{{ asset('front-end/images/footer/recent-news-3.jpg') }}" alt="Awesome Image">
                                <div class="overlay-style-one">
                                    <div class="box">
                                        <div class="content">
                                            <a href="project-single.html"><span class="icon-next"></span></a>
                ...
                <div class="single-footer-widget">
                    <div class="brochures-carousel-box owl-carousel owl-theme">
                        ...
                        <div class="single-item">
                            <div class="img-holder">
                                <img src="{{ asset('front-end/images/footer/brochures-1.jpg') }}" alt="Awesome Image">
                            </div>
                            <div class="title-holder">
