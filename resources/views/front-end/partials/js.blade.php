...
<script src="{{asset('front-end/js/jquery.bootstrap-touchspin.js') }}"></script>
<script src="{{asset('front-end/js/jquery.countTo.js') }}"></script>
<script src="{{asset('front-end/js/jquery.easing.min.js') }}"></script>
<script src="{{asset('front-end/js/jquery.enllax.min.js') }}"></script>
<script src="{{asset('front-end/js/jquery.fancybox.js') }}"></script>
<script src="{{asset('front-end/js/jquery.mixitup.min.js') }}"></script>
<script src="{{asset('front-end/js/jquery.paroller.min.js') }}"></script>
...
<script src="{{asset('front-end/assets/language-switcher/jquery.polyglot.language.switcher.js') }}"></script>
<script src="{{asset('front-end/assets/timepicker/timePicker.js') }}"></script>
<script src="{{asset('front-end/assets/html5lightbox/html5lightbox.js') }}"></script>
